...
{
    public class CommunicationRepository : GenericRepository<Communications>, ICommunicationRepository
    {
        public CommunicationRepository(ECommerceDbContext context) : base(context)
        {
        }
